...
# Mrege --->
from align.deploy.mtcnn_detector import MtcnnDetector
#import tensormsa_insightface.src.common.face_preprocess as face_preprocess
...
class FaceModel:
  ...
  def get_feature(self, face_img, bbox, points):
    # bbox, points = self.get_boxes(face_img)
